  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'radial-gradient(ellipse at center, rgba(14,12,10,0.2) 0%, rgba(14,12,10,0.7) 100%)',
      }} />
      ...
      <div style={{
        ...
        >
          ...
          <div style={{
            ...
            SYSTEM STATUS: ANONYMOUS ACCESS ENABLED<br />
            <span style={{ color: '#5B7A9E' }}>// ENCRYPTED SESSION · NO CREDENTIALS STORED</span>
          </div>
        </motion.div>
      </div>
    </div>
